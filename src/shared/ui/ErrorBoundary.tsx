    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-[200px] bg-slate-50 dark:bg-slate-900/50 text-slate-800 dark:text-slate-200 font-sans p-4 rounded-xl">
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg border border-slate-100 dark:border-slate-700 max-w-md w-full text-center space-y-3">
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button 
                ...
                className="flex-1 py-2.5 px-4 bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-300 text-sm font-medium rounded-lg shadow-sm transition-colors duration-200 focus:ring-2 focus:ring-slate-400 focus:ring-offset-2"
              >
                Reload Page
              </button>
            </div>
