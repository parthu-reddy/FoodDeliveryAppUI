...
import { createApiClient as create_internalDriver } from './internal_driver_controller';
...
import { createApiClient as create_internalDriverBeneficiary } from './internal_driver_beneficiary_controller';
...
export function createDeliveryFacade(baseUrl: string, options?: ZodiosOptions) {
  return {
  internalDriver: create_internalDriver(baseUrl, options),
  ...
  internalDriverBeneficiary: create_internalDriverBeneficiary(baseUrl, options),
