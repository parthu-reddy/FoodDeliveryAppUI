...
import { createApiClient as create_internalRestaurantBeneficiary } from './internal_restaurant_beneficiary_controller';
...
export function createRestaurantFacade(baseUrl: string, options?: ZodiosOptions) {
  ...
  internalRestaurantBeneficiary: create_internalRestaurantBeneficiary(baseUrl, options),
