              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="space-y-3 flex-1 pb-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <input
                      ...
                      className="col-span-2 w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500/50"
                    />
                    ...
                    <input
                      ...
                      className="w-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500/50"
                    />
                ...
                <div className="flex flex-col gap-2 mt-auto">
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-lg shadow-orange-500/20 py-3.5 rounded-2xl font-bold hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center justify-center gap-2"
                  >
                  ...
                  {onSelectDeliveryLocation && (
                    <button 
                      ...
                      className="w-full py-3.5 bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 rounded-2xl font-bold hover:bg-indigo-100 dark:hover:bg-indigo-500/20 transition-all flex items-center justify-center gap-2"
                    >
