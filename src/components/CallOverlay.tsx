...
export const CallOverlay: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Sound Assets */}
      <audio ref={ringingAudioRef} loop src="https://actions.google.com/sounds/v1/alarms/phone_ringing.ogg" className="hidden" preload="auto" />
      <audio ref={dialingAudioRef} loop src="https://actions.google.com/sounds/v1/communications/dial_tone.ogg" className="hidden" preload="auto" />
      <audio ref={busyAudioRef} src="https://actions.google.com/sounds/v1/alarms/beep_short.ogg" className="hidden" preload="auto" />
