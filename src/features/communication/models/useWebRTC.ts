      ...
      if (token) {
        await savePendingUpload({
          ...
          timestamp: Date.now()
            ...
            await chatApi.chatAudioUpload.post('/api/v1/chat/sessions/:sessionId/upload-audio', formData as unknown as { file: string }, { params: { sessionId } } as { params: { sessionId: string } });
