...
function AdminFleetMapInner() {
 ...
 el.className = 'fleet-marker w-8 h-8 bg-rose-600 rounded-full flex items-center justify-center shadow-lg border-2 border-white text-white shadow-rose-600/50 cursor-pointer pointer-events-auto';
 ...
 const el = document.createElement('div');
 el.className = 'fleet-marker w-8 h-8 bg-amber-500 rounded-full flex items-center justify-center shadow-lg border-2 border-white text-white shadow-amber-500/50 cursor-pointer pointer-events-auto';
 ...
 {toastMsg && (
 <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-50 bg-slate-800 text-white px-4 py-2 rounded-full shadow-lg font-medium text-sm duration-300">
 {toastMsg}
 </div>
 )}
 </div>
